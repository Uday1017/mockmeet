...
const Chat = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-100 px-4 sm:px-6 py-3 sm:py-4">
        <div className="max-w-3xl mx-auto flex items-center gap-3 sm:gap-4">
          <button
            ...
            className="text-gray-400 hover:text-gray-600 transition-colors text-lg sm:text-base"
          >
            ←
          </button>
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-xs sm:text-sm flex-shrink-0">
      ...
      {/* Input */}
      <div className="bg-white border-t border-gray-100 px-3 sm:px-4 py-3 sm:py-4">
        <div className="max-w-3xl mx-auto flex items-center gap-2 sm:gap-3">
          <input
            ...
            className="flex-1 px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
          <button
            onClick={sendMessage}
            disabled={!input.trim()}
            className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-gray-200 text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-sm font-medium transition-colors flex-shrink-0"
          >
            Send
          </button>
        </div>
